-- Função para dropar a view
CREATE OR REPLACE FUNCTION drop_view_agendamentos_completo()
RETURNS text
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
-- Função para criar a view com todos os campos necessários
CREATE OR REPLACE FUNCTION create_view_agendamentos_completo()
RETURNS text
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
BEGIN
    ...
    RETURN 'View created successfully with all required fields';
END;
$$;

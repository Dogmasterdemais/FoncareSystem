...
-- Comentários sobre o script corrigido:
-- 1. Script completamente corrigido com sintaxe SQL válida
-- 2. Limitado às especialidades disponíveis na clínica
-- 3. Valores configurados para Valor/Hora (regime PJ)
-- 4. 80 profissionais distribuídos equilibradamente
-- 5. Faixas salariais realistas por especialidade:
...
-- 6. Registros profissionais adequados por categoria
-- 7. Distribuição equilibrada entre as especialidades da clínica
